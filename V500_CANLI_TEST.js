...
ok('surum adi V501 PARITY AUDIT ADAYI', (((((((has('V5_0_1_PARITY_AUDIT_CANDIDATE')||has('V5_0_2_LEVLOCK_BOTH_ENDS')) || src.includes('V5_0_3_TESTNET_UNIVERSE_PREFILTER')) || src.includes('V5_0_4_TAKER_FROM_BACKTEST')) || src.includes('V5_0_5_VOTE_EXACT_BACKTEST')) || src.includes('V5_0_6_LOSS_TELEMETRY')) || src.includes('V5_0_7_LEVPROOF_RETRY')) || src.includes('V5_0_8_BACKOFF_HONORED'))); // V501: V500 temel C1-C5 regresyonu yeni build adina uyarlandi
