...
// V4.7.4.43-BH1: operator onceligi duzeltildi; EXACT artik TUM listeyi kapsiyor.
ok('exact mod kosulu tum listeyi kapsiyor',
   /if \(V592_EXACT_BACKTEST_AUTHORITY && \(action\.type === 'EMERGENCY_EXIT'/.test(src));
ok('eski hatali oncelik kalmadi',
   !/if \(V592_EXACT_BACKTEST_AUTHORITY && action\.type === 'EMERGENCY_EXIT' \|\|/.test(src));
...
ok('session 4_7_4_43_AF1', /V592_EXACT_CLOSED1M_R495_72H_4_7_4_43_AF1/.test(src));
