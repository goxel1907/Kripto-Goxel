...
{
  const S = 'V592_EXACT_CLOSED1M_R495_72H_4_7_4_7_PA1';
...
console.log('\n── T9  F01 geri alındı + sözleşme değişmedi ' + '─'.repeat(26));
{
  ...
  ok('T9j build V4.7.4.7', has(/V4_7_4_7_PIT_ALIGN_RISK41_10X/));
  ok('T9k session 4_7_4_7', has(/V592_EXACT_CLOSED1M_R495_72H_4_7_4_7_PA1/));
