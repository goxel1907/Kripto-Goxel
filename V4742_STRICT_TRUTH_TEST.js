...
const sandbox = (extra = {}) => vm.createContext({
  ...
  fs, path,
  v592ProbePreempt: async()=>false,   // V4.7.4.34-AX1: strateji emri oncesi sonda itilir
  ...extra
});
...
console.log('\n── C6  Kimlik + strateji sözleşmesi ' + '─'.repeat(34));
{
  ...
  ok('C6a build V4.7.4.41', has(/V4_7_4_41_PROBE_PERSIST_RISK41_10X/));
  ok('C6b session 4_7_4_10', has(/V592_EXACT_CLOSED1M_R495_72H_4_7_4_41_PS1/));
