...
console.log('\n── I3  Kimlik ' + '─'.repeat(56));
{
  ok('I3a build V4.7.4.21', /V4_7_4_21_UNPROTECTED_EXCEPTION_RISK41_10X/.test(src));
  ok('I3b session 4_7_4_21_UP1', /V592_EXACT_CLOSED1M_R495_72H_4_7_4_21_UP1/.test(src));
