...
{
  let c=mk(30000,{isBinanceBackoffActive:()=>true});
...
{
  const h=re=>re.test(src);
  ok('K4a build V4.7.4.10', h(/V4_7_4_10_FRESHNESS_BUDGET_RISK41_10X/));
  ok('K4b session 4_7_4_10_FB1', h(/V592_EXACT_CLOSED1M_R495_72H_4_7_4_10_FB1/));
