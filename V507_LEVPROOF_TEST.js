...
ok('build V5_0_7', ((has('V5_0_7_LEVPROOF_RETRY') || src.includes('V5_0_8_BACKOFF_HONORED')) || src.includes('V5_0_9_SL_CONTRACT_LOCKED') || src.includes('V5_1_0_SCAN_DECOUPLED')));
